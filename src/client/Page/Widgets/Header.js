...
class UserSnipet extends Component {
  ...
  render() {
    ...
    return (
      <div className="w3-bar-item w3-round-large w3-dropdown-click" style={{margin: '4px 0', padding: '3px 16px', cursor: 'pointer'}}>
        ...
        <div className={`${this.state.show? 'w3-show': ''} w3-dropdown-content w3-bar-block w3-border`} style={{margin: '3px 0px 3px -16px'}}>
